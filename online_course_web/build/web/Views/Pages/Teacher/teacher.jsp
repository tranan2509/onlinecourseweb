...
<html>
    <head>
        ...
        <link rel="stylesheet" href="Views/Css/common.css">
         <link rel="stylesheet" href="Views/Css/Profile/teacher.css">
...
//                newText.setAttribute('id', 'text-course-teacher' + '-idCourse');
                ...
                var newButtonEdit = document.createElement('i');
//                newButtonEdit.setAttribute('class', 'btn-course');
                 newButtonEdit.setAttribute('class', 'fas fa-edit');
...
//                newButtonDelete.innerHTML = '-';
            ...
            //nhấn vào ô khóa học đc duyệt
            function clickApprovedCourse()
            {
                var div_ = document.getElementById("list-approved-course-teacher");
            ...
            function clickUnapprovedCourses()
            {
                var div_ = document.getElementById("list-not-approved-course-teacher");
                if(div_.style.display=="none")
                {
                    div_.style.display="block";
                }
        ...
        <div class = 'div_menu'>
            <div class="small-container horizontal">
                ...
                <div id='div_account' class="div_account">
                    <label id='label_account'><c:out value='${User.getName()}'></c:out> </label>
            ...
            <div class ='div-content'>
                <div class='div-contain-course-list'>
                    <div class ='div-function-name'>
                        <h1 id ="h1-function-name">DANH SÁCH CÁC KHÓA HỌC</h1>
                    </div>
                    <div class="div-display-content">
                        <div class="title-course">
                            <input class="input_courseOption" id="input_ApprovedCourses" type="button" value="Các khóa học đã được duyệt" 
                                   onclick="clickApprovedCourse()">
                        </div>
                        <div class="div-list-course" id="list-approved-course-teacher">
                            ...
                            <script>
                                addCourse("<c:out value='<%= Courses.get(i).getName()%>'/>", "<%= Courses.get(i).getCourseId()%>");
                            </script>
                            <%}
                            %>
                        </div>
                    ...
                    <div class="title-course">
                        <input class="input_courseOption" id="input_ApprovedCourses" type="button" 
                               value="Các khóa học chưa được duyệt" onclick="clickUnapprovedCourses()">
                    </div>
                    <div class="div-list-course" id="list-not-approved-course-teacher">
                        <%
